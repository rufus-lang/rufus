             ...
             globals => #{'Broken' => [{func, #{exprs => [{identifier, #{line => 7,
                          ...
                          'Echo' => [{func, #{exprs => [{match, #{left => {identifier, #{line => 4,
                                                        ...
                                                        {identifier, #{line => 5,
                                                                       spec => a}}],
                                              line => 3,
                                              params => {params, #{params => [{param, #{line => 3,
                                                                   spec => n,
                                                                   type => {type, #{line => 3,
                                                                                    source => rufus_text,
                                                                                    spec => string}}}}]}},
...
typecheck_and_annotate_for_function_taking_an_atom_and_returning_an_atom_literal_test() ->
    ...
    Expected = [
        {module, #{line => 2,
                   spec => example}},
        {func, #{params => {params, #{params => [{param, #{line => 3,
                                      spec => m,
                                      type => {type, #{line => 3,
                                                       spec => atom,
                                                       source => rufus_text}}}}]}},
    ...
    Expected = [{module, #{line => 2, spec => example}},
                {func, #{exprs => [{atom_lit, #{line => 3,
                                                ...
                                                type => {type, #{line => 3,
                                                                 ...
                                                                 spec => atom}}}}],
                         line => 3,
                         params => {params, #{params => [{atom_lit, #{line => 3,
                                                 spec => ok,
                                                 type => {type, #{line => 3,
                                                                  source => inferred,
                                                                  spec => atom}}}}]}},
    ...
    Expected = [{module, #{line => 2, spec => example}},
                {func, #{exprs => [{bool_lit, #{line => 3,
                                                ...
                                                type => {type, #{line => 3,
                                                                 ...
                                                                 spec => bool}}}}],
                         line => 3,
                         params => {params, #{params => [{bool_lit, #{line => 3,
                                                 spec => true,
                                                 type => {type, #{line => 3,
                                                                  source => inferred,
                                                                  spec => bool}}}}]}},
    ...
    Expected = [{module, #{line => 2, spec => example}},
                {func, #{exprs => [{float_lit, #{line => 3,
                                                 ...
                                                 type => {type, #{line => 3,
                                                                  ...
                                                                  spec => float}}}}],
                         line => 3,
                         params => {params, #{params => [{float_lit, #{line => 3,
                                                  spec => 1.0,
                                                  type => {type, #{line => 3,
                                                                   source => inferred,
                                                                   spec => float}}}}]}},
    ...
    Expected = [{module, #{line => 2, spec => example}},
                {func, #{exprs => [{int_lit, #{line => 3,
                                               ...
                                               type => {type, #{line => 3,
                                                                ...
                                                                spec => int}}}}],
                         line => 3,
                         params => {params, #{params => [{int_lit, #{line => 3,
                                                spec => 1,
                                                type => {type, #{line => 3,
                                                                 source => inferred,
                                                                 spec => int}}}}]}},
    ...
    Expected = [{module, #{line => 2, spec => example}},
                {func, #{exprs => [{string_lit, #{line => 3,
                                                  ...
                                                  type => {type, #{line => 3,
                                                                   ...
                                                                   spec => string}}}}],
                         line => 3,
                         params => {params, #{params => [{string_lit, #{line => 3,
                                                   spec => <<"ok">>,
                                                   type => {type, #{line => 3,
                                                                    source => inferred,
                                                                    spec => string}}}}]}},
