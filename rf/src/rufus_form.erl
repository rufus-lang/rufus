...
-spec make_literal(list | literal(), type_form(), atom() | list(), term()) -> literal_form().
make_literal(list, ElementType, Elements, Line) ->
    TypeForm = make_type(list, ElementType, Line),
